                  ...
                  Bot.updateQuickAccess({
                    ...
                    "How to apply": {
                      'callBack': () => {
                        Bot.createBox('How to apply', 'user')
                        AI.setContext(['MBA', 'admission'])
                        AI.getData(['MBA', 'admission', "how to apply"])
                          .then(data => { Bot.createBox(data, 'bot', true, remember) })
                        Bot.resetQuickAccess()
                      }
                    },
                    "Eligibility criteria": {
                      'callBack': () => {
                        Bot.createBox('Eligibility criteria', 'user')
                        AI.setContext(['MBA', 'admission'])
                        AI.getData(['MBA', 'admission', "eligibility criteria"])
                          .then(data => { Bot.createBox(data, 'bot', true, remember) })
                        Bot.resetQuickAccess()
                      }
                    },
                    "Fee structure": {
                      'callBack': () => {
                        Bot.createBox('Fee structure', 'user')
                        AI.setContext(['MBA', 'admission'])
                        AI.getData(['MBA', 'admission', "fee structure"])
                          .then(data => { Bot.createBox(data, 'bot', true, remember) })
                        Bot.resetQuickAccess()
                      }
                    },
                    "Documents for physical verification": {
                      'callBack': () => {
                        ...
                        AI.setContext(['MBA', 'admission'])
                        AI.getData(['MBA', 'admission', "documents for physical verification"])
                          .then(data => { Bot.createBox(data, 'bot', true, remember) })
                        Bot.resetQuickAccess()
                      }
                    },
                    "Documents for interview": {
                      'callBack': () => {
                        ...
                        AI.setContext(['MBA', 'admission'])
                        AI.getData(['MBA', 'admission', "documents for interview"])
                          .then(data => { Bot.createBox(data, 'bot', true, remember) })
                        Bot.resetQuickAccess()
                      }
                    }
